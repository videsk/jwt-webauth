...
export default class WebAuth {
    ...
    createChecker() {
        ...
        * All expires if server return error 4XX
            ...
            this.checkExpiration('access')
              .then(expired => {
                  if (expired) {
                      ...
                      // If the response is with 4XX code execute expired function
        ...
        // Create interval
        this.interval.execute = (this.interval.try <= maxAttempts) ? window.setInterval(handler, 1000) : this.expire();
    }
